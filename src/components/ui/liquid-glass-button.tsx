...
const liquidbuttonVariants = cva(
    "inline-flex items-center transition-colors justify-center cursor-pointer gap-2 whitespace-nowrap rounded-xl text-sm font-semibold transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] min-w-[120px]",
    {
        variants: {
            variant: {
                default: "bg-emerald-600/80 hover:bg-emerald-500/90 text-white hover:scale-105 duration-300 transition",
                soft: "border border-[var(--border-color)] bg-[var(--bg-surface)] text-[var(--accent)] hover:bg-[var(--bg-secondary)] hover:text-[var(--accent)] shadow-none hover:scale-100",
                destructive: "bg-red-500/80 text-white hover:bg-red-600/90 hover:scale-105 duration-300 transition focus-visible:ring-red-500/20",
                outline: "border border-white/10 bg-dark-300/40 text-gray-300 hover:bg-emerald-500/20 hover:border-emerald-500/30 hover:text-white hover:scale-105 duration-300 transition",
...
function LiquidButton({
    ...
    return (
        ...
        dark:shadow-[0_0_8px_rgba(0,0,0,0.03),0_2px_6px_rgba(0,0,0,0.08),inset_3px_3px_0.5px_-3.5px_rgba(255,255,255,0.09),inset_-3px_-3px_0.5px_-3.5px_rgba(255,255,255,0.85),inset_1px_1px_1px_-0.5px_rgba(255,255,255,0.6),inset_-1px_-1px_1px_-0.5px_rgba(255,255,255,0.6),inset_0_0_6px_6px_rgba(255,255,255,0.12),inset_0_0_2px_2px_rgba(255,255,255,0.06),0_0_12px_rgba(0,0,0,0.15)]" />
                ...
                <div className={cn("flex items-center gap-2", useGlass ? "pointer-events-none z-10" : "relative z-10")}>
                    {children}
                </div>
            </Comp>
        </>
